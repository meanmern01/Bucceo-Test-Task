...
const DestinationCard = ({ image, location, description, key }: propsTypes) => {
    return (
        <div key={key} className=" flex flex-col w-[162px] md:w-[150px] lg:w-[162px] gap-1 items-center justify-center last:hidden md:last:flex">

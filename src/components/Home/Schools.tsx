...
const Schools = ({ title }: propsTypes) => {
  ...
  return (
    <section className="mx-auto w-[90%]  xl:max-w-[1199px] py-[60px] md:py-[100px] 2xl:max-w-[1320px]">
      <h1 className="text-center text-2xl sm:text-[32px] font-normal pb-9">
        {title}
      </h1>
      ...
      <div className="flex flex-wrap gap-4 m-auto md:hidden">
        ...
        <p
          className="px-[14px] text-2xl sm:text-[32px] text-right w-full cursor-pointer"

...
const Service = () => {
  return (
    <div className="py-5">
      <div className="bg-white border-2 border-slate-300 rounded-md px-4   flex flex-col md:flex-row justify-around items-start gap-2 p-5">
        ...
        <div className="p-3 flex flex-col gap-2 items-start justify-center rounded-lg w-full md:w-1/2">
          ...
          <button className="bg-blue-500 sm:w-fit md:w-[300px] text-white p-2 rounded ">
            Contract Shop
          </button>
        </div>
      </div>
